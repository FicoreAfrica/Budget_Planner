QUIZ_TRANSLATIONS = {
    ...
    'ha': {
        ...
        'quiz_balanced_insight': 'Daidaitaccen kashe da ajiye kuɗi.',
        'quiz_spender_insight': 'Jin daɗin kashe kuɗi.',
        'quiz_avoider_insight': 'Shiri yana da ƙalubale.',
        'quiz_planer_tip': 'Kafa maƙasudai na dogon lokaci.',
        'quiz_saver_tip': 'Ka ji game da saka zinariya.',
        ...
        'badge_financials_guru': 'Gurun Kuɗi',
        'badge_savingss_star': 'Tauraron Ajiye Kuɗi',
        'badge_firsts_quizs_completed': 'Tambayar Farko An Kammala!',
        'badge_needs_guidance': 'Yana Bukatar Jagora!',
        'quiz_use_budgeting_quiz': 'Gwada amfani da manhajar kashema kamar PiggyVestma ko Moniepoint don bin diddigin kashe.',
        'quiz_set_emergency_fund': 'Kafa asusun gaggawa tare da Cowrywise don gagganwar yanke.',
        'quiz_review_goals': 'Duba ma kamarasudai kowane wata don bin diddigi.',
        'quiz_personality_quiz': 'Tambayar Hali',
        'quiz_assess_literacy': 'Tantance Ilimin Kuɗin Ka',
        'quiz_start_personality_quiz': 'Fara Tantance Halin Kudi'
    }
}
