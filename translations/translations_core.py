CORE_TRANSLATIONS = {
    'en': {
        ...
        'faq_fund_handling_answer': 'No, Ficore is not a bank and does not hold or move funds. We provide tools for financial planning.',
    ...
    'ha': {
        ...
        'faq_fund_handling_answer': 'A’a, Ficore ba banki ba ne kuma ba ya riƙe ko motsa kuɗi. Muna ba da kayan aiki don tsara kuɗi.',
